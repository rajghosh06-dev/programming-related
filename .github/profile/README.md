...
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>1</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Programming for Problem Solving</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">PPS</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>C</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.08);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>2</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Data Structures Coursework</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">DS</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>C, C++</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>3</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Object Oriented Programming</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">OOP</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>Java</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.08);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>4</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Web Technologies Lab</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">WT</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>HTML, CSS, JavaScript, PHP, MySQL</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>5</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Design and Analysis of Algorithms</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">DAA</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>C++, Java</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.08);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>6</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Operating System Practice</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">OS</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>C, Shell</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;"><strong>7</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><strong>Assembly Language Programming</strong></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;">ALP</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px;"><code>Assembly</code></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.16); border-radius: 4px; text-align: center;">✅ Active</td></tr>
</table>
...
<tr style="background: rgba(255, 0, 255, 0.08);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;"><a href="https://github.com/rajghosh06-dev/programming-related/commit/e3a6178c9ac29f783590850476e51ff8dc2614bb" style="color: #FF00FF; text-decoration: none; font-weight: 600;">e3a6178</a></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">docs: remove competing .github README</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Rishit Ghosh</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Apr 12, 2026</td></tr>
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;"><a href="https://github.com/rajghosh06-dev/programming-related/commit/d3fbcc97aa084f7a3b282d68cf66a571fad4bb96" style="color: #FF00FF; text-decoration: none; font-weight: 600;">d3fbcc9</a></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">chore: sync README automation</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">rajghosh06-dev</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Apr 12, 2026</td></tr>
<tr style="background: rgba(255, 0, 255, 0.08);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;"><a href="https://github.com/rajghosh06-dev/programming-related/commit/f79420fcda372f2e3f995d93b4cfb9781de2160a" style="color: #FF00FF; text-decoration: none; font-weight: 600;">f79420f</a></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Merge branch &#x27;main&#x27; of github.com:rajghosh06-dev/programming</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Rishit Ghosh</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Apr 12, 2026</td></tr>
<tr style="background: rgba(255, 0, 255, 0.04);"><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;"><a href="https://github.com/rajghosh06-dev/programming-related/commit/e6005cbd6ad64aae571eba62327a027da3f7bb48" style="color: #FF00FF; text-decoration: none; font-weight: 600;">e6005cb</a></td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">docs: refresh automation READMEs for flattened structure Rev</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Rishit Ghosh</td><td style="padding: 12px; border: 1px solid rgba(255, 0, 255, 0.15); border-radius: 4px;">Apr 12, 2026</td></tr>
</table>
...
<td style="padding: 12px; border: 1px solid rgba(255, 0, 110, 0.15); border-radius: 4px;"><code>2026-04-12 09:21:26 UTC</code></td>
</tr>
</table>
