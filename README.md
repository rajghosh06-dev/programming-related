...
```
PROGRAMMING-RELATED/
├── 1st-Year/                          # Coursework and practice from 1st year
│   ├── Programming-for-Problem-Solving/  # C programs and problem-solving basics
│   └── Others/                           # Miscellaneous assignments/projects
├── 2nd-Year/                          # Coursework and projects from 2nd year
│   ├── 2-1/                              # Semester 2-1 programs and assignments
│   └── 2-2/                              # Semester 2-2 programs and assignments
...
3. Compile or run the program using the appropriate compiler/interpreter:
   - **C/C++** → `gcc filename.c -o output && ./output`
   - **Java** → `javac filename.java && java ClassName`
   - **Python** → `python filename.py`

    > (Commands may vary slightly depending on your OS and environment.)
...
- College assignments and practice problems
